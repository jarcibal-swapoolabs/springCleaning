...
public class testBaseWorking {
	...
	public testBaseWorking(){
		try 
		{
			prop = new Properties();
			FileInputStream ip = new FileInputStream(System.getProperty("user.dir")+ "/src/main/java/com/springSeven"
					+ "/qa/config/config.properties");prop.load(ip);
		}
...
//		}
		 ...
		 if(System.getProperty("BROWSER") != null &&
				...
				testBaseWorking.dockerf();
	        }else{
	    		testBaseWorking.dockerc();
	        }
